...
<i>❝لا يمكن التنبؤ بتصنيع وحدة المعالجة المركزية لدرجة أنه يجب اختبار كل شريحة نظرًا لأن غالبية الرقائق النهائية معيبة. يتم تخصيص رقم طراز وسعر لتلك المنتجات التي تبقى على قيد الحياة مما يعكس أقصى أداء آمن لها.❞</i>
