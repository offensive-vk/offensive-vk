...
🔭_الكمال ليس هو`goal`_.<br>🧑‍💻 أحب التدقيق على الكمبيوتر و`code`.<br>🤝 أنا .<br>✨العيش داخل`terminal`.<br>🌱 أنا أتعلم حاليًا_ماجستير في القانون_شيء.<br>💬 اسألني عن الأتمتة.<br>⚡ حقيقة ممتعة: ليس هناك متعة، فقط السجلات.<br>💥لا تفكر، فقط افعل.<br>📧_سوف تجد وسيلة_.

<!--STARTS_HERE_QUOTE_README-->

<i>❝"تجدر الإشارة إلى أنه لن يوافق أي مهندس برمجيات مدرب أخلاقيًا على كتابة إجراء DestroyBaghdad. بدلاً من ذلك، ستتطلب الأخلاقيات المهنية الأساسية منه كتابة إجراء DestroyCity، والذي يمكن إعطاء بغداد له كمعلمة. "- ناثانيال س. بورنشتاين ❞</i>
