...
# For the universal image, oryx build tool installs the detected platforms in /home/offensive/*. Hence, linking current platforms to the /home/offensive/ path and adding it to the PATH.
# This ensures that whatever platfornm versions oryx detects and installs are set as root.
NODE_PATH="/home/offensive/nvm/current"
ln -snf /usr/local/share/nvm /home/offensive
...
JAVA_PATH="/home/offensive/java/current"
ln -snf /usr/local/sdkman/candidates/java /home/offensive
