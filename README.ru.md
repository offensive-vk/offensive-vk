...
<i>❝ «Как правило, программные системы не работают должным образом до тех пор, пока их не используют и неоднократно терпят неудачу в реальных приложениях». — Дэйв Парнас ❞</i>
