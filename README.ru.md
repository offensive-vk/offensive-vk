...
<i>❝elgoog.im (Google, написанное наоборот) — это зеркальный веб-сайт поиска Google с горизонтально перевернутыми результатами поиска, также известный как «зеркало Google». Неофициальный сайт elgooG был создан All Too Flat «для развлечения» и начал набирать популярность в 2002 году❞</i>
