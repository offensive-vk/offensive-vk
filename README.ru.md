...
<i>❝ «Менее 10% кода связано с предполагаемым назначением системы; остальная часть занимается вводом-выводом, проверкой данных, обслуживанием структуры данных и другими служебными задачами» — Мэри Шоу ❞</i>
