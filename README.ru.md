...
<i>❝Тот факт, что на клавиатуре есть кнопки типа «Q», «W», «E», «R», «T» и «Y». Когда была изобретена клавиатура, на ней были кнопки в алфавитном порядке, в результате скорость набора текста была слишком высокой, и компьютер зависал. Так, чтобы снизить скорость работы человека, была изобретена qwerty-клавиатура.❞</i>
