...
<i>❝Раньше существовал компьютерный червь, который мог получить доступ к вашей ОС Windows XP, мог загрузить патч от Microsoft, чтобы устранить уязвимость, и использовал его для заражения системы, а затем удалил себя.❞</i>
