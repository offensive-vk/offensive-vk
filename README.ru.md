...
<i>❝"Все детали должны соединяться без приложения усилий. Вы должны помнить, что детали, которые вы собираете, были разобраны вами. Поэтому, если вы не можете собрать их снова, должна быть причина. Ни в коем случае не используйте молоток" — Руководство IBM, 1925 г. ❞</i>
