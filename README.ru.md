...
<i>❝Mircosoft включила Solitaire в свои операционные системы, «чтобы успокоить людей, напуганных операционной системой», познакомить пользователей с графическими пользовательскими интерфейсами и научить их пользоваться мышью.❞</i>
