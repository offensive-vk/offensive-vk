...
<i>❝Первым микропроцессором, созданным Intel, был микропроцессор. Он был разработан для калькулятора, и в то время никто не предполагал, к чему это приведет.❞</i>
