...
<i>❝ «Давайте изменим наше традиционное отношение к созданию программ: вместо того, чтобы воображать, что наша главная задача — дать команду компьютеру, что делать, давайте сосредоточимся на объяснении людям того, что мы хотим, чтобы компьютер делал». — Дональд Э. Кнут ❞</i>
