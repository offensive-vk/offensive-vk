...
<i>❝Компьютер Tandy TRS-80 Model I излучал столько помех, что многие игры были разработаны таким образом, чтобы для передачи звука можно было использовать AM-радио, находящееся рядом с компьютером.❞</i>
