...
<i>❝cpu Производство настолько непредсказуемо, что каждый чип должен быть проверен, поскольку большинство готовых чипов дефектны. Тем, кто выживает, присваивается номер модели, а цена отражает их максимальную безопасную производительность.</i>
