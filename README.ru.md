...
<i>❝ «Программирование без учета общей архитектуры или дизайна похоже на исследование пещеры с одним лишь фонариком: вы не знаете, где вы были, вы не знаете, куда идете, и вы не совсем понимаете, где находитесь». — Дэнни Торп ❞</i>
